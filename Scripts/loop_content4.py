...
# Load the JSON file
with open("JSON/Article_Links/social_articles_4_1to15.json", "r", encoding="utf-8") as file:
...
with open("JSON/Article_Content/social_content_4_1to15.json", "w", encoding="utf-8") as outfile:
